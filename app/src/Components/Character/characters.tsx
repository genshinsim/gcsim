...
export const items = {
  English: Object.keys(characterKeyToICharacter.English).map(
    (k) => characterKeyToICharacter.English[k]
  ),
  Chinese: Object.keys(characterKeyToICharacter.Chinese).map(
    (k) => characterKeyToICharacter.Chinese[k]
  ),
};
  ...
  English: (
    ...
    return (
      <MenuItem
        ...
        label={elementRender.English[item.element]}
        key={item.key}
        onClick={handleClick}
  ...
  Chinese: (
    ...
    return (
      <MenuItem
        active={modifiers.active}
        disabled={modifiers.disabled}
        label={elementRender.Chinese[item.element]}
        key={item.key}
        onClick={handleClick}
        text={highlightText(item.name, query)}
      />
