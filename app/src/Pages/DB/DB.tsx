  ...
  return (
    <div className="m-2 flex flex-col">
      ...
      <div className="capitalize flex flex-row">
        <img
          src={'https://gcsim.app/api/assets/weapons/' + char.weapon + '.png'}
          alt={char.name}
    ...
    <main className="flex flex-col h-full m-2 w-full xs:w-full sm:w-[640px] hd:w-full wide:w-[1160px] ml-auto mr-auto ">
      <span className="ml-auto mr-auto mb-4">
        <Callout intent="danger" className="max-w-[600px] mt-4">
          The database contains sims that are pre core rewrite (no hitlag and
          out of date frame data) and is currently shown only for archival
          purposes. Please be patient as we are currently working on a new
          version. Thanks!
        </Callout>
      </span>
      ...
      <Dialog isOpen={cfg !== ''} onClose={() => setCfg('')}>
        <div className={Classes.DIALOG_BODY}>
          ...
          <Callout intent="danger" className="mt-2">
            This config will not work in the current gcsim version. Please check
            the{' '}
