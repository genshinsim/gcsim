...
func init() {
	// low_plunge -> x
	lowPlungeFrames = frames.InitAbilSlice(85)
	lowPlungeFrames[action.ActionAttack] = 54
	lowPlungeFrames[action.ActionSkill] = 54
	lowPlungeFrames[action.ActionBurst] = 55
	lowPlungeFrames[action.ActionDash] = 41
	lowPlungeFrames[action.ActionWalk] = 84
	...
	highPlungeFrames[action.ActionBurst] = 54
	highPlungeFrames[action.ActionDash] = 41
	highPlungeFrames[action.ActionJump] = 83
