...
func (b *Bunny) HandleAttack(atk *model.AttackEvent) float64 {
...
func (b *Bunny) attachEle(atk *model.AttackEvent) {
	// check for ICD first
	existing := b.Reactable.ActiveAuraString()
	applied := atk.Info.Durability
...
func (b *Bunny) React(a *model.AttackEvent) {
