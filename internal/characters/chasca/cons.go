...
func (c *char) c2cb(src int) model.AttackCBFunc {
	if c.Base.Cons < 2 {
		return nil
	}
	return func(ac model.AttackCB) {
		if c.c2Src == src {
			return
		}
		c.c2Src = src
...
func (c *char) c4cb(src int) model.AttackCBFunc {
	if c.Base.Cons < 4 {
		return nil
	}
	return func(ac model.AttackCB) {
...
func (c *char) c6buff() func(*model.Snapshot) {
	if c.Base.Cons < 6 {
		return nil
	}
	if c.Base.Ascension < 1 {
