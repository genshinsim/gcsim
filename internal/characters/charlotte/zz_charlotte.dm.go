...
func init() {
	...
	validation.RegisterCharParamValidationFunc(keys.Charlotte, func(a action.Action, keys []string) error {
...
var (
	attack = [][]float64{
		{ // attack: CoolColorCapture - 1-Hit DMG: {0}
			0.498456,
			0.53584,
			0.573224,
			0.62307,
		...
		{ // attack: CoolColorCapture - 2-Hit DMG: {1}
			0.433752,
			0.466283,
			0.498815,
			0.54219,
		...
		{ // attack: CoolColorCapture - 3-Hit DMG: {2}
			0.646008,
			0.694459,
			0.742909,
			0.80751,
	...
	// attack: CoolColorCapture - Charged Attack DMG: {3}
	charge = []float64{
		1.00512,
		1.080504,
		1.155888,
	...
	// attack: CoolColorCapture - Plunge DMG: {5}
	collision = []float64{
		0.568288,
		0.614544,
		0.6608,
	...
	// attack: CoolColorCapture - Low/High Plunge DMG: {6}/{7}
	lowPlunge = []float64{
		1.136335,
		1.228828,
		1.32132,
	...
	// attack: CoolColorCapture - Spiritbreath Thorn DMG: {8}
	arkhe = []float64{
		0.11168,
		0.120056,
		0.128432,
	...
	// skill: FramingFreezingPointComposition - Photo DMG (Press): {0}
	skillPress = []float64{
		0.672,
		0.7224,
		0.7728,
	...
	// skill: FramingFreezingPointComposition - Photo DMG (Hold): {1}
	skillHold = []float64{
		1.392,
		1.4964,
		1.6008,
	...
	// skill: FramingFreezingPointComposition - "Snappy Silhouette" Mark DMG: {2}
	...
	// skill: FramingFreezingPointComposition - "Focused Impression" Mark DMG: {5}
