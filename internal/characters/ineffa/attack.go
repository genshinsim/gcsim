...
var (
	attackFrames          [][]int
	attackHitmarks        = [][]int{{7}, {16}, {27, 40}, {30}}
	attackHitlagHaltFrame = [][]float64{{0.06}, {0.06}, {0.06, 0.06}, {0.06}}
	attackDefHalt         = [][]bool{{true}, {true}, {true, true}, {true}}
...
func init() {
	...
	attackFrames[3] = frames.InitNormalCancelSlice(attackHitmarks[3][0], 30)
	attackFrames[3][action.ActionWalk] = 39
}
