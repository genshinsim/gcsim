...
func init() {
	...
	lowPlungeFrames[action.ActionDash] = 38
	lowPlungeFrames[action.ActionSwap] = 62

	// high_plunge -> x
	highPlungeFrames = frames.InitAbilSlice(80)
	highPlungeFrames[action.ActionAttack] = 52
	highPlungeFrames[action.ActionSkill] = 53
	highPlungeFrames[action.ActionBurst] = 52
	highPlungeFrames[action.ActionDash] = 40
	highPlungeFrames[action.ActionJump] = 79
