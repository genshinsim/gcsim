...
func NewWeapon(c *core.Core, char *character.CharWrapper, p weapon.WeaponProfile) (weapon.Weapon, error) {
	...
	char.AddStatMod(character.StatMod{Base: modifier.NewBase("jadecutter-hp", -1), AffectedStat: attributes.NoStat, Amount: func() ([]float64, bool) {
		return mHP, true
	}})
	...
	char.AddStatMod(character.StatMod{Base: modifier.NewBase("jadecutter-atk-buff", -1), AffectedStat: attributes.ATK, Amount: func() ([]float64, bool) {
