...
image_name: "UI_EquipIcon_Claymore_Widsith"
base_stats: {
   base_props: {
      prop_type: FIGHT_PROP_BASE_ATTACK
      initial_value: 49.137699127197266
      curve: GROW_CURVE_ATTACK_303
   }
   base_props: {
      prop_type: FIGHT_PROP_PHYSICAL_ADD_HURT
      initial_value: 0.04500000178813934
