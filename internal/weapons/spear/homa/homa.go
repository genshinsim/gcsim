...
func NewWeapon(c *core.Core, char *character.CharWrapper, p weapon.WeaponProfile) (weapon.Weapon, error) {
	...
	char.AddStatMod(character.StatMod{Base: modifier.NewBase("homa-hp", -1), AffectedStat: attributes.NoStat, Amount: func() ([]float64, bool) {
		return mHP, true
	}})
	...
	char.AddStatMod(character.StatMod{Base: modifier.NewBase("homa-atk-buff", -1), AffectedStat: attributes.ATK, Amount: func() ([]float64, bool) {
		maxhp := char.MaxHP()
		per := atkp
