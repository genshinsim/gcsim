...
func InitAlgoV1(cfg string, simopt simulator.Options, simcfg core.SimulationConfig, optionsMap map[string]float64, sugarLog *zap.SugaredLogger) *AlgoV1 {
	a := AlgoV1{}
...
func (a *AlgoV1) OptimizeSubstats() {
	...
	a.stats = InitOptimStats(a.simcfg, int(a.optionsMap["indiv_liquid_cap"]), int(a.optionsMap["total_liquid_substats"]))
	...
	a.stats.setInitialSubstats(fixedSubstatCount)
