      ...
      <div className="px-3 xs:px-16 py-3 flex justify-center gap-2 2xl:mx-auto 2xl:container">
        ...
        <div className="flex flex-wrap gap-x-4 gap-y-2 text-lg font-medium shrink grow-0">
          <IconContext.Provider value={{ size: "32px", color: "inherit" }}>
            ...
            <a className={linkClass} href="https://github.com/genshinsim/gsim" target="_blank" rel="noreferrer">
              <AiFillGithub />
              <span>GitHub</span>
            </a>
            <a className={linkClass} href="https://ko-fi.com/srliao" target="_blank" rel="noreferrer">
              <SiKofi />
              <span>Ko-Fi</span>
            </a>
