...
import artifactPipelineData from "./artifact.dm.json";
import charPipelineData from "./character.dm.json";
import weaponPipelineData from "./weapon.dm.json";
...
export const valid_stats: string[] = [
	"hp",
	"hp%",
	"atk",
	"atk%",
...
export const valid_enemies: string[] = Object.keys(
	resources.en.game.monster_names,
);
