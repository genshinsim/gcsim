...
export const Entry: MessageFns<Entry> = {
  encode(message: Entry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.summary !== undefined) {
      EntrySummary.encode(message.summary, writer.uint32(98).fork()).join();
    }
    return writer;
  },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            message.create_date = longToNumber(reader.uint64());
            continue;
          }
          case 3: {
            if (tag !== 26) {
          ...
          case 10: {
            ...
            message.last_update = longToNumber(reader.uint64());
            continue;
          }
          case 11: {
            if (tag !== 90) {
...
export const EntrySummary: MessageFns<EntrySummary> = {
  encode(message: EntrySummary, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.sim_duration !== undefined) {
      DescriptiveStats.encode(message.sim_duration, writer.uint32(10).fork()).join();
    }
    if (message.mode !== undefined && message.mode !== 0) {
      writer.uint32(16).int32(message.mode);
    }
    if (message.total_damage !== undefined) {
      DescriptiveStats.encode(message.total_damage, writer.uint32(26).fork()).join();
    }
    ...
    if (message.team !== undefined && message.team.length !== 0) {
      for (const v of message.team) {
        Character.encode(v!, writer.uint32(58).fork()).join();
      }
    }
    globalThis.Object.entries(message.dps_by_target || {}).forEach(([key, value]: [string, DescriptiveStats]) => {
      EntrySummary_DpsByTargetEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): EntrySummary {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): EntrySummary {
    return {
      ...
      dps_by_target: isObject(object.dps_by_target)
        ? (globalThis.Object.entries(object.dps_by_target) as [string, any][]).reduce(
  ...
  toJSON(message: EntrySummary): unknown {
    ...
    if (message.dps_by_target) {
      const entries = globalThis.Object.entries(message.dps_by_target) as [string, DescriptiveStats][];
      if (entries.length > 0) {
        obj.dps_by_target = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<EntrySummary>, I>>(object: I): EntrySummary {
    ...
    message.dps_by_target = (globalThis.Object.entries(object.dps_by_target ?? {}) as [string, DescriptiveStats][])
      .reduce((acc: { [key: string]: DescriptiveStats }, [key, value]: [string, DescriptiveStats]) => {
        if (value !== undefined) {
...
export const EntrySummary_DpsByTargetEntry: MessageFns<EntrySummary_DpsByTargetEntry> = {
  encode(message: EntrySummary_DpsByTargetEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EntrySummary_DpsByTargetEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const Entries: MessageFns<Entries> = {
  encode(message: Entries, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Entries {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            const el = Entry.decode(reader, reader.uint32());
            if (el !== undefined) {
...
export const QueryOpt: MessageFns<QueryOpt> = {
  encode(message: QueryOpt, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== undefined) {
      Struct.encode(Struct.wrap(message.query), writer.uint32(10).fork()).join();
    }
    if (message.sort !== undefined) {
      Struct.encode(Struct.wrap(message.sort), writer.uint32(18).fork()).join();
    }
    if (message.project !== undefined) {
      Struct.encode(Struct.wrap(message.project), writer.uint32(26).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): QueryOpt {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ComputeWork: MessageFns<ComputeWork> = {
  encode(message: ComputeWork, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._id !== undefined && message._id !== "") {
      writer.uint32(10).string(message._id);
    }
    if (message.config !== undefined && message.config !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ComputeWork {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const GetRequest: MessageFns<GetRequest> = {
  encode(message: GetRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== undefined) {
      QueryOpt.encode(message.query, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const GetResponse: MessageFns<GetResponse> = {
  encode(message: GetResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.data !== undefined) {
      Entries.encode(message.data, writer.uint32(10).fork()).join();
    }
    return writer;
  },
...
export const GetOneResponse: MessageFns<GetOneResponse> = {
  encode(message: GetOneResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.data !== undefined) {
      Entry.encode(message.data, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetOneResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const GetPendingRequest: MessageFns<GetPendingRequest> = {
  encode(message: GetPendingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tag !== undefined && message.tag !== 0) {
      writer.uint32(8).int32(message.tag);
    }
    if (message.query !== undefined) {
      QueryOpt.encode(message.query, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): GetPendingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const GetPendingResponse: MessageFns<GetPendingResponse> = {
  encode(message: GetPendingResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.data !== undefined) {
      Entries.encode(message.data, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetPendingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const GetBySubmitterRequest: MessageFns<GetBySubmitterRequest> = {
  encode(message: GetBySubmitterRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.submitter !== undefined && message.submitter !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetBySubmitterRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const GetBySubmitterResponse: MessageFns<GetBySubmitterResponse> = {
  encode(message: GetBySubmitterResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.data !== undefined) {
      Entries.encode(message.data, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetBySubmitterResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const GetAllRequest: MessageFns<GetAllRequest> = {
  encode(message: GetAllRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.query !== undefined) {
      QueryOpt.encode(message.query, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAllRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const GetAllResponse: MessageFns<GetAllResponse> = {
  encode(message: GetAllResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.data !== undefined) {
      Entries.encode(message.data, writer.uint32(10).fork()).join();
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): GetAllResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ApproveTagRequest: MessageFns<ApproveTagRequest> = {
  encode(message: ApproveTagRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ApproveTagRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ApproveTagResponse: MessageFns<ApproveTagResponse> = {
  encode(message: ApproveTagResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== undefined && message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ApproveTagResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const RejectTagRequest: MessageFns<RejectTagRequest> = {
  encode(message: RejectTagRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== undefined && message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    if (message.tag !== undefined && message.tag !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RejectTagRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const RejectTagResponse: MessageFns<RejectTagResponse> = {
  encode(message: RejectTagResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== undefined && message.id !== "") {
      writer.uint32(10).string(message.id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RejectTagResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const RejectTagAllUnapprovedRequest: MessageFns<RejectTagAllUnapprovedRequest> = {
  encode(message: RejectTagAllUnapprovedRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.tag !== undefined && message.tag !== 0) {
      writer.uint32(8).int32(message.tag);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RejectTagAllUnapprovedRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const RejectTagAllUnapprovedResponse: MessageFns<RejectTagAllUnapprovedResponse> = {
  encode(message: RejectTagAllUnapprovedResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RejectTagAllUnapprovedResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const DeletePendingRequest: MessageFns<DeletePendingRequest> = {
  encode(message: DeletePendingRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._id !== undefined && message._id !== "") {
      writer.uint32(10).string(message._id);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeletePendingRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const DeletePendingResponse: MessageFns<DeletePendingResponse> = {
  encode(message: DeletePendingResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._id !== undefined && message._id !== "") {
      writer.uint32(10).string(message._id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DeletePendingResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const GetWorkRequest: MessageFns<GetWorkRequest> = {
  encode(_: GetWorkRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },
...
export const GetWorkResponse: MessageFns<GetWorkResponse> = {
  encode(message: GetWorkResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.data !== undefined && message.data.length !== 0) {
      for (const v of message.data) {
        ComputeWork.encode(v!, writer.uint32(10).fork()).join();
      }
    }
    return writer;
  },
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            const el = ComputeWork.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.data!.push(el);
            }
            continue;
...
export const RejectWorkRequest: MessageFns<RejectWorkRequest> = {
  encode(message: RejectWorkRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== undefined && message.id !== "") {
      writer.uint32(10).string(message.id);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): RejectWorkRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const RejectWorkResponse: MessageFns<RejectWorkResponse> = {
  encode(_: RejectWorkResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): RejectWorkResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const CompleteWorkRequest: MessageFns<CompleteWorkRequest> = {
  encode(message: CompleteWorkRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._id !== undefined && message._id !== "") {
      writer.uint32(10).string(message._id);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CompleteWorkRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const CompleteWorkResponse: MessageFns<CompleteWorkResponse> = {
  encode(message: CompleteWorkResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._id !== undefined && message._id !== "") {
      writer.uint32(10).string(message._id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CompleteWorkResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const WorkStatusRequest: MessageFns<WorkStatusRequest> = {
  encode(_: WorkStatusRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WorkStatusRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const WorkStatusResponse: MessageFns<WorkStatusResponse> = {
  encode(message: WorkStatusResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WorkStatusResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ReplaceConfigRequest: MessageFns<ReplaceConfigRequest> = {
  encode(message: ReplaceConfigRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._id !== undefined && message._id !== "") {
      writer.uint32(10).string(message._id);
    }
    if (message.config !== undefined && message.config !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReplaceConfigRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ReplaceConfigResponse: MessageFns<ReplaceConfigResponse> = {
  encode(message: ReplaceConfigResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._id !== undefined && message._id !== "") {
      writer.uint32(10).string(message._id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReplaceConfigResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ReplaceDescRequest: MessageFns<ReplaceDescRequest> = {
  encode(message: ReplaceDescRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._id !== undefined && message._id !== "") {
      writer.uint32(10).string(message._id);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReplaceDescRequest {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ReplaceDescResponse: MessageFns<ReplaceDescResponse> = {
  encode(message: ReplaceDescResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message._id !== undefined && message._id !== "") {
      writer.uint32(10).string(message._id);
    }
    return writer;
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ReplaceDescResponse {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export class DBStoreClientImpl implements DBStore {
  ...
  RejectTagAllUnapproved(request: RejectTagAllUnapprovedRequest): Promise<RejectTagAllUnapprovedResponse> {
    ...
    return promise.then((data) => RejectTagAllUnapprovedResponse.decode(new BinaryReader(data)));
  }
  ...
  DeletePending(request: DeletePendingRequest): Promise<DeletePendingResponse> {
    ...
    return promise.then((data) => DeletePendingResponse.decode(new BinaryReader(data)));
  }
