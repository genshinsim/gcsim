...
export const AvatarDataMap: MessageFns<AvatarDataMap> = {
  encode(message: AvatarDataMap, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.data || {}).forEach(([key, value]: [string, AvatarData]) => {
      AvatarDataMap_DataEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AvatarDataMap {
    ...
    return {
      data: isObject(object.data)
        ? (globalThis.Object.entries(object.data) as [string, any][]).reduce(
          (acc: { [key: string]: AvatarData }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: AvatarData.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
  ...
  toJSON(message: AvatarDataMap): unknown {
    const obj: any = {};
    if (message.data) {
      const entries = globalThis.Object.entries(message.data) as [string, AvatarData][];
      if (entries.length > 0) {
        obj.data = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<AvatarDataMap>, I>>(object: I): AvatarDataMap {
    const message = createBaseAvatarDataMap();
    message.data = (globalThis.Object.entries(object.data ?? {}) as [string, AvatarData][]).reduce(
      (acc: { [key: string]: AvatarData }, [key, value]: [string, AvatarData]) => {
        if (value !== undefined) {
...
export const AvatarDataMap_DataEntry: MessageFns<AvatarDataMap_DataEntry> = {
  encode(message: AvatarDataMap_DataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      AvatarData.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AvatarDataMap_DataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const AvatarData: MessageFns<AvatarData> = {
  encode(message: AvatarData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.stats !== undefined) {
      AvatarStatsData.encode(message.stats, writer.uint32(82).fork()).join();
    }
    if (message.skill_details !== undefined) {
      AvatarSkillsData.encode(message.skill_details, writer.uint32(90).fork()).join();
    }
...
export const AvatarStatsData: MessageFns<AvatarStatsData> = {
  encode(message: AvatarStatsData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.promo_data !== undefined && message.promo_data.length !== 0) {
      for (const v of message.promo_data) {
        PromotionData.encode(v!, writer.uint32(58).fork()).join();
      }
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AvatarStatsData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 7: {
            ...
            const el = PromotionData.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.promo_data!.push(el);
            }
            continue;
          }
          case 8: {
...
export const AvatarSkillsData: MessageFns<AvatarSkillsData> = {
  encode(message: AvatarSkillsData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 5: {
            ...
            const el = AvatarSkillExcelIndexData.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.attack_scaling!.push(el);
            }
            continue;
          }
          case 6: {
...
export const AvatarSkillExcelIndexData: MessageFns<AvatarSkillExcelIndexData> = {
  encode(message: AvatarSkillExcelIndexData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.level_data !== undefined && message.level_data.length !== 0) {
      for (const v of message.level_data) {
        AvatarSkillExcelLevelData.encode(v!, writer.uint32(26).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): AvatarSkillExcelIndexData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 3: {
            ...
            const el = AvatarSkillExcelLevelData.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.level_data!.push(el);
            }
            continue;
          }
        }
...
export const AvatarSkillExcelLevelData: MessageFns<AvatarSkillExcelLevelData> = {
  encode(message: AvatarSkillExcelLevelData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): AvatarSkillExcelLevelData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const WeaponDataMap: MessageFns<WeaponDataMap> = {
  encode(message: WeaponDataMap, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.data || {}).forEach(([key, value]: [string, WeaponData]) => {
      WeaponDataMap_DataEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WeaponDataMap {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): WeaponDataMap {
    return {
      data: isObject(object.data)
        ? (globalThis.Object.entries(object.data) as [string, any][]).reduce(
          (acc: { [key: string]: WeaponData }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: WeaponData.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
  ...
  toJSON(message: WeaponDataMap): unknown {
    const obj: any = {};
    if (message.data) {
      const entries = globalThis.Object.entries(message.data) as [string, WeaponData][];
      if (entries.length > 0) {
        obj.data = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<WeaponDataMap>, I>>(object: I): WeaponDataMap {
    const message = createBaseWeaponDataMap();
    message.data = (globalThis.Object.entries(object.data ?? {}) as [string, WeaponData][]).reduce(
      (acc: { [key: string]: WeaponData }, [key, value]: [string, WeaponData]) => {
        if (value !== undefined) {
...
export const WeaponDataMap_DataEntry: MessageFns<WeaponDataMap_DataEntry> = {
  encode(message: WeaponDataMap_DataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      WeaponData.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WeaponDataMap_DataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const WeaponData: MessageFns<WeaponData> = {
  encode(message: WeaponData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== undefined && message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.key !== undefined && message.key !== "") {
    ...
    if (message.base_stats !== undefined) {
      WeaponStatsData.encode(message.base_stats, writer.uint32(50).fork()).join();
    }
    if (message.name_text_hash_map !== undefined && message.name_text_hash_map !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WeaponData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const WeaponStatsData: MessageFns<WeaponStatsData> = {
  encode(message: WeaponStatsData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.base_props !== undefined && message.base_props.length !== 0) {
      for (const v of message.base_props) {
        WeaponProp.encode(v!, writer.uint32(10).fork()).join();
      }
    }
    if (message.promo_data !== undefined && message.promo_data.length !== 0) {
      for (const v of message.promo_data) {
        PromotionData.encode(v!, writer.uint32(18).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): WeaponStatsData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            const el = WeaponProp.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.base_props!.push(el);
            }
            continue;
          }
          case 2: {
...
export const WeaponProp: MessageFns<WeaponProp> = {
  encode(message: WeaponProp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): WeaponProp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ArtifactDataMap: MessageFns<ArtifactDataMap> = {
  encode(message: ArtifactDataMap, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.data || {}).forEach(([key, value]: [string, ArtifactData]) => {
      ArtifactDataMap_DataEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ArtifactDataMap {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): ArtifactDataMap {
    return {
      data: isObject(object.data)
        ? (globalThis.Object.entries(object.data) as [string, any][]).reduce(
          (acc: { [key: string]: ArtifactData }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: ArtifactData.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
  ...
  toJSON(message: ArtifactDataMap): unknown {
    const obj: any = {};
    if (message.data) {
      const entries = globalThis.Object.entries(message.data) as [string, ArtifactData][];
      if (entries.length > 0) {
        obj.data = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<ArtifactDataMap>, I>>(object: I): ArtifactDataMap {
    const message = createBaseArtifactDataMap();
    message.data = (globalThis.Object.entries(object.data ?? {}) as [string, ArtifactData][]).reduce(
      (acc: { [key: string]: ArtifactData }, [key, value]: [string, ArtifactData]) => {
        if (value !== undefined) {
...
export const ArtifactDataMap_DataEntry: MessageFns<ArtifactDataMap_DataEntry> = {
  encode(message: ArtifactDataMap_DataEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      ArtifactData.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ArtifactDataMap_DataEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ArtifactData: MessageFns<ArtifactData> = {
  encode(message: ArtifactData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== undefined && message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    ...
    if (message.image_names !== undefined) {
      ArtifactImageData.encode(message.image_names, writer.uint32(34).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ArtifactData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): ArtifactData {
    return {
      id: isSet(object.id) ? globalThis.Number(object.id) : isSet(object.set_id) ? globalThis.Number(object.set_id) : 0,
...
export const ArtifactImageData: MessageFns<ArtifactImageData> = {
  encode(message: ArtifactImageData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ArtifactImageData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const PromotionData: MessageFns<PromotionData> = {
  encode(message: PromotionData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.add_props !== undefined && message.add_props.length !== 0) {
      for (const v of message.add_props) {
        PromotionAddProp.encode(v!, writer.uint32(18).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): PromotionData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            const el = PromotionAddProp.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.add_props!.push(el);
            }
            continue;
          }
        }
...
export const PromotionAddProp: MessageFns<PromotionAddProp> = {
  encode(message: PromotionAddProp, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.prop_type !== undefined && message.prop_type !== 0) {
      writer.uint32(8).int32(message.prop_type);
    }
    if (message.value !== undefined && message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): PromotionAddProp {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const MonsterData: MessageFns<MonsterData> = {
  encode(message: MonsterData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.id !== undefined && message.id !== 0) {
      writer.uint32(8).uint32(message.id);
    }
    if (message.key !== undefined && message.key !== "") {
    ...
    if (message.base_stats !== undefined) {
      MonsterStatsData.encode(message.base_stats, writer.uint32(26).fork()).join();
    }
    if (message.name_text_hash_map !== undefined && message.name_text_hash_map !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MonsterData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const MonsterStatsData: MessageFns<MonsterStatsData> = {
  encode(message: MonsterStatsData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.base_hp !== undefined && message.base_hp !== 0) {
      writer.uint32(9).double(message.base_hp);
    }
    if (message.hp_curve !== undefined && message.hp_curve !== 0) {
    ...
    if (message.resist !== undefined) {
      MonsterResistData.encode(message.resist, writer.uint32(26).fork()).join();
    }
    ...
    if (message.hp_drop !== undefined && message.hp_drop.length !== 0) {
      for (const v of message.hp_drop) {
        MonsterHPDrop.encode(v!, writer.uint32(42).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): MonsterStatsData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 5: {
            ...
            const el = MonsterHPDrop.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.hp_drop!.push(el);
            }
            continue;
          }
        }
...
export const MonsterResistData: MessageFns<MonsterResistData> = {
  encode(message: MonsterResistData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MonsterResistData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const MonsterHPDrop: MessageFns<MonsterHPDrop> = {
  encode(message: MonsterHPDrop, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): MonsterHPDrop {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
