  ...
  encode(message: Sample, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.logs !== undefined && message.logs.length !== 0) {
      for (const v of message.logs) {
        Struct.encode(Struct.wrap(v!), writer.uint32(74).fork()).join();
      }
    }
    return writer;
  },
