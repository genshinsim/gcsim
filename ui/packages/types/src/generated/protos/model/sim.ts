...
export const Character: MessageFns<Character> = {
  encode(message: Character, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.weapon !== undefined) {
      Weapon.encode(message.weapon, writer.uint32(50).fork()).join();
    }
    if (message.talents !== undefined) {
      CharacterTalents.encode(message.talents, writer.uint32(58).fork()).join();
    }
    globalThis.Object.entries(message.sets || {}).forEach(([key, value]: [string, number]) => {
      Character_SetsEntry.encode({ key: key as any, value }, writer.uint32(66).fork()).join();
    });
  ...
  fromJSON(object: any): Character {
    return {
      ...
      sets: isObject(object.sets)
        ? (globalThis.Object.entries(object.sets) as [string, any][]).reduce(
      ...
      snapshot: globalThis.Array.isArray(object?.snapshot)
        ? object.snapshot.map((e: any) => globalThis.Number(e))
        : globalThis.Array.isArray(object?.snapshot_stats)
        ? object.snapshot_stats.map((e: any) => globalThis.Number(e))
        : [],
    };
  },
  ...
  toJSON(message: Character): unknown {
    ...
    if (message.sets) {
      const entries = globalThis.Object.entries(message.sets) as [string, number][];
      if (entries.length > 0) {
        obj.sets = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<Character>, I>>(object: I): Character {
    ...
    message.talents = (object.talents !== undefined && object.talents !== null)
      ...
      : undefined;
    message.sets = (globalThis.Object.entries(object.sets ?? {}) as [string, number][]).reduce(
...
export const Character_SetsEntry: MessageFns<Character_SetsEntry> = {
  encode(message: Character_SetsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Character_SetsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const CharacterTalents: MessageFns<CharacterTalents> = {
  encode(message: CharacterTalents, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): CharacterTalents {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const Weapon: MessageFns<Weapon> = {
  encode(message: Weapon, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.name !== undefined && message.name !== "") {
      writer.uint32(10).string(message.name);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Weapon {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const Enemy: MessageFns<Enemy> = {
  encode(message: Enemy, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    globalThis.Object.entries(message.resist || {}).forEach(([key, value]: [string, number]) => {
      Enemy_ResistEntry.encode({ key: key as any, value }, writer.uint32(26).fork()).join();
    });
    if (message.position !== undefined) {
      Coord.encode(message.position, writer.uint32(34).fork()).join();
    }
  ...
  fromJSON(object: any): Enemy {
    return {
      level: isSet(object.level) ? globalThis.Number(object.level) : 0,
      hp: isSet(object.hp) ? globalThis.Number(object.hp) : isSet(object.HP) ? globalThis.Number(object.HP) : 0,
      resist: isObject(object.resist)
        ? (globalThis.Object.entries(object.resist) as [string, any][]).reduce(
          (acc: { [key: string]: number }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: globalThis.Number(value),
              enumerable: true,
      ...
      position: isSet(object.position)
        ? Coord.fromJSON(object.position)
        : isSet(object.pos)
        ? Coord.fromJSON(object.pos)
        : undefined,
  ...
  toJSON(message: Enemy): unknown {
    ...
    if (message.resist) {
      const entries = globalThis.Object.entries(message.resist) as [string, number][];
      if (entries.length > 0) {
        obj.resist = {};
        entries.forEach(([k, v]) => {
          obj.resist[k] = v;
  ...
  fromPartial<I extends Exact<DeepPartial<Enemy>, I>>(object: I): Enemy {
    ...
    message.resist = (globalThis.Object.entries(object.resist ?? {}) as [string, number][]).reduce(
      (acc: { [key: string]: number }, [key, value]: [string, number]) => {
        if (value !== undefined) {
          acc[key] = globalThis.Number(value);
        }
...
export const Enemy_ResistEntry: MessageFns<Enemy_ResistEntry> = {
  encode(message: Enemy_ResistEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Enemy_ResistEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const SimulatorSettings: MessageFns<SimulatorSettings> = {
  encode(message: SimulatorSettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.delays !== undefined) {
      Delays.encode(message.delays, writer.uint32(58).fork()).join();
    }
...
export const Delays: MessageFns<Delays> = {
  encode(message: Delays, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.skill !== undefined && message.skill !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): Delays {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const EnergySettings: MessageFns<EnergySettings> = {
  encode(message: EnergySettings, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EnergySettings {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
