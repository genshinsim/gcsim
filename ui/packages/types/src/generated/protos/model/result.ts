...
export const SimulationResult: MessageFns<SimulationResult> = {
  encode(message: SimulationResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.schema_version !== undefined) {
      Version.encode(message.schema_version, writer.uint32(10).fork()).join();
    }
    ...
    if (message.simulator_settings !== undefined) {
      SimulatorSettings.encode(message.simulator_settings, writer.uint32(58).fork()).join();
    }
    if (message.energy_settings !== undefined) {
      EnergySettings.encode(message.energy_settings, writer.uint32(66).fork()).join();
    }
    ...
    if (message.character_details !== undefined && message.character_details.length !== 0) {
      for (const v of message.character_details) {
        Character.encode(v!, writer.uint32(82).fork()).join();
      }
    }
    if (message.target_details !== undefined && message.target_details.length !== 0) {
      for (const v of message.target_details) {
        Enemy.encode(v!, writer.uint32(90).fork()).join();
      }
    }
    if (message.player_position !== undefined) {
      Coord.encode(message.player_position, writer.uint32(130).fork()).join();
    }
    ...
    if (message.statistics !== undefined) {
      SimulationStatistics.encode(message.statistics, writer.uint32(98).fork()).join();
    }
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 10: {
            ...
            if (el !== undefined) {
              message.character_details!.push(el);
            }
            continue;
          }
          case 11: {
            ...
            if (el !== undefined) {
              message.target_details!.push(el);
            }
            continue;
          }
          case 16: {
          ...
          case 17: {
            ...
            if (el !== undefined) {
              message.incomplete_characters!.push(el);
            }
            continue;
          }
          case 12: {
          ...
          case 15: {
            ...
            message.created_date = longToNumber(reader.int64());
            continue;
          }
        }
        if ((tag & 7) === 4 || tag === 0) {
  ...
  fromJSON(object: any): SimulationResult {
    return {
      ...
      config_file: isSet(object.config_file)
        ...
        : isSet(object.config)
        ? globalThis.String(object.config)
        : "",
...
export const SimulationStatistics: MessageFns<SimulationStatistics> = {
  encode(message: SimulationStatistics, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.duration !== undefined) {
      OverviewStats.encode(message.duration, writer.uint32(58).fork()).join();
    }
    if (message.dps !== undefined) {
      OverviewStats.encode(message.dps, writer.uint32(66).fork()).join();
    }
    if (message.rps !== undefined) {
      OverviewStats.encode(message.rps, writer.uint32(74).fork()).join();
    }
    if (message.eps !== undefined) {
      OverviewStats.encode(message.eps, writer.uint32(82).fork()).join();
    }
    if (message.hps !== undefined) {
      OverviewStats.encode(message.hps, writer.uint32(90).fork()).join();
    }
    if (message.shp !== undefined) {
      OverviewStats.encode(message.shp, writer.uint32(98).fork()).join();
    }
    if (message.total_damage !== undefined) {
      DescriptiveStats.encode(message.total_damage, writer.uint32(106).fork()).join();
    }
    if (message.warnings !== undefined) {
      Warnings.encode(message.warnings, writer.uint32(114).fork()).join();
    }
    if (message.failed_actions !== undefined && message.failed_actions.length !== 0) {
      for (const v of message.failed_actions) {
        FailedActions.encode(v!, writer.uint32(122).fork()).join();
      }
    }
    globalThis.Object.entries(message.element_dps || {}).forEach(([key, value]: [string, DescriptiveStats]) => {
      SimulationStatistics_ElementDpsEntry.encode({ key: key as any, value }, writer.uint32(130).fork()).join();
    });
    globalThis.Object.entries(message.target_dps || {}).forEach(([key, value]: [string, DescriptiveStats]) => {
      SimulationStatistics_TargetDpsEntry.encode({ key: key as any, value }, writer.uint32(138).fork()).join();
    });
    if (message.character_dps !== undefined && message.character_dps.length !== 0) {
      for (const v of message.character_dps) {
        DescriptiveStats.encode(v!, writer.uint32(146).fork()).join();
      }
    }
    if (message.dps_by_element !== undefined && message.dps_by_element.length !== 0) {
      for (const v of message.dps_by_element) {
        ElementStats.encode(v!, writer.uint32(154).fork()).join();
      }
    }
    if (message.dps_by_target !== undefined && message.dps_by_target.length !== 0) {
      for (const v of message.dps_by_target) {
        TargetStats.encode(v!, writer.uint32(162).fork()).join();
      }
    }
    if (message.source_dps !== undefined && message.source_dps.length !== 0) {
      for (const v of message.source_dps) {
        SourceStats.encode(v!, writer.uint32(194).fork()).join();
      }
    }
    if (message.source_damage_instances !== undefined && message.source_damage_instances.length !== 0) {
      for (const v of message.source_damage_instances) {
        SourceStats.encode(v!, writer.uint32(242).fork()).join();
      }
    }
    if (message.damage_buckets !== undefined) {
      BucketStats.encode(message.damage_buckets, writer.uint32(170).fork()).join();
    }
    if (message.cumu_damage_contrib !== undefined) {
      CharacterBucketStats.encode(message.cumu_damage_contrib, writer.uint32(178).fork()).join();
    }
    if (message.cumu_damage !== undefined) {
      TargetBucketStats.encode(message.cumu_damage, writer.uint32(250).fork()).join();
    }
    globalThis.Object.entries(message.shields || {}).forEach(([key, value]: [string, ShieldInfo]) => {
      SimulationStatistics_ShieldsEntry.encode({ key: key as any, value }, writer.uint32(186).fork()).join();
    });
    if (message.field_time !== undefined && message.field_time.length !== 0) {
      for (const v of message.field_time) {
        DescriptiveStats.encode(v!, writer.uint32(202).fork()).join();
      }
    }
    if (message.total_source_energy !== undefined && message.total_source_energy.length !== 0) {
      for (const v of message.total_source_energy) {
        SourceStats.encode(v!, writer.uint32(210).fork()).join();
      }
    }
    if (message.source_reactions !== undefined && message.source_reactions.length !== 0) {
      for (const v of message.source_reactions) {
        SourceStats.encode(v!, writer.uint32(218).fork()).join();
      }
    }
    if (message.character_actions !== undefined && message.character_actions.length !== 0) {
      for (const v of message.character_actions) {
        SourceStats.encode(v!, writer.uint32(226).fork()).join();
      }
    }
    if (message.target_aura_uptime !== undefined && message.target_aura_uptime.length !== 0) {
      for (const v of message.target_aura_uptime) {
        SourceStats.encode(v!, writer.uint32(234).fork()).join();
      }
    }
    if (message.end_stats !== undefined && message.end_stats.length !== 0) {
      for (const v of message.end_stats) {
        EndStats.encode(v!, writer.uint32(258).fork()).join();
      }
    }
    if (message.dev_debug !== undefined) {
      DevDebugData.encode(message.dev_debug, writer.uint32(802).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SimulationStatistics {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 15: {
            ...
            const el = FailedActions.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.failed_actions!.push(el);
            }
            continue;
          }
          case 16: {
          ...
          case 18: {
            ...
            const el = DescriptiveStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.character_dps!.push(el);
            }
            continue;
          }
          case 19: {
            ...
            const el = ElementStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.dps_by_element!.push(el);
            }
            continue;
          }
          case 20: {
            ...
            const el = TargetStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.dps_by_target!.push(el);
            }
            continue;
          }
          case 24: {
            ...
            const el = SourceStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.source_dps!.push(el);
            }
            continue;
          }
          case 30: {
            ...
            const el = SourceStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.source_damage_instances!.push(el);
            }
            continue;
          }
          case 21: {
          ...
          case 26: {
            ...
            const el = SourceStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.total_source_energy!.push(el);
            }
            continue;
          }
          case 27: {
            ...
            const el = SourceStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.source_reactions!.push(el);
            }
            continue;
          }
          case 28: {
            ...
            const el = SourceStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.character_actions!.push(el);
            }
            continue;
          }
          case 29: {
            ...
            const el = SourceStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.target_aura_uptime!.push(el);
            }
            continue;
          }
          case 32: {
            ...
            const el = EndStats.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.end_stats!.push(el);
            }
            continue;
          }
          case 100: {
  ...
  fromJSON(object: any): SimulationStatistics {
    return {
      ...
      dps: isSet(object.dps)
        ? OverviewStats.fromJSON(object.dps)
        : isSet(object.DPS)
        ? OverviewStats.fromJSON(object.DPS)
        : undefined,
      rps: isSet(object.rps)
        ? OverviewStats.fromJSON(object.rps)
        : isSet(object.RPS)
        ? OverviewStats.fromJSON(object.RPS)
        : undefined,
      eps: isSet(object.eps)
        ? OverviewStats.fromJSON(object.eps)
        : isSet(object.EPS)
        ? OverviewStats.fromJSON(object.EPS)
        : undefined,
      hps: isSet(object.hps)
        ? OverviewStats.fromJSON(object.hps)
        : isSet(object.HPS)
        ? OverviewStats.fromJSON(object.HPS)
        : undefined,
      shp: isSet(object.shp)
        ? OverviewStats.fromJSON(object.shp)
        : isSet(object.SHP)
        ? OverviewStats.fromJSON(object.SHP)
        : undefined,
      ...
      element_dps: isObject(object.element_dps)
        ? (globalThis.Object.entries(object.element_dps) as [string, any][]).reduce(
          (acc: { [key: string]: DescriptiveStats }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: DescriptiveStats.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
      ...
      target_dps: isObject(object.target_dps)
        ? (globalThis.Object.entries(object.target_dps) as [string, any][]).reduce(
          (acc: { [key: number]: DescriptiveStats }, [key, value]: [string, any]) => {
      ...
      dps_by_element: globalThis.Array.isArray(object?.dps_by_element)
        ...
        : globalThis.Array.isArray(object?.breakdown_by_element_dps)
        ? object.breakdown_by_element_dps.map((e: any) => ElementStats.fromJSON(e))
        : [],
      dps_by_target: globalThis.Array.isArray(object?.dps_by_target)
        ? object.dps_by_target.map((e: any) => TargetStats.fromJSON(e))
        : globalThis.Array.isArray(object?.breakdown_by_target_dps)
        ? object.breakdown_by_target_dps.map((e: any) => TargetStats.fromJSON(e))
        : [],
      ...
      cumu_damage_contrib: isSet(object.cumu_damage_contrib)
        ...
        : isSet(object.cumulative_damage_contribution)
        ? CharacterBucketStats.fromJSON(object.cumulative_damage_contribution)
        : undefined,
      cumu_damage: isSet(object.cumu_damage)
        ? TargetBucketStats.fromJSON(object.cumu_damage)
        : isSet(object.cumulative_damage)
        ? TargetBucketStats.fromJSON(object.cumulative_damage)
        : undefined,
      shields: isObject(object.shields)
        ? (globalThis.Object.entries(object.shields) as [string, any][]).reduce(
          (acc: { [key: string]: ShieldInfo }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: ShieldInfo.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
  ...
  toJSON(message: SimulationStatistics): unknown {
    ...
    if (message.element_dps) {
      const entries = globalThis.Object.entries(message.element_dps) as [string, DescriptiveStats][];
      if (entries.length > 0) {
        obj.element_dps = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.target_dps) {
      const entries = globalThis.Object.entries(message.target_dps) as [string, DescriptiveStats][];
      if (entries.length > 0) {
        obj.target_dps = {};
        entries.forEach(([k, v]) => {
    ...
    if (message.shields) {
      const entries = globalThis.Object.entries(message.shields) as [string, ShieldInfo][];
      if (entries.length > 0) {
        obj.shields = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<SimulationStatistics>, I>>(object: I): SimulationStatistics {
    ...
    message.element_dps = (globalThis.Object.entries(object.element_dps ?? {}) as [string, DescriptiveStats][]).reduce(
      (acc: { [key: string]: DescriptiveStats }, [key, value]: [string, DescriptiveStats]) => {
        if (value !== undefined) {
    ...
    message.target_dps = (globalThis.Object.entries(object.target_dps ?? {}) as [string, DescriptiveStats][]).reduce(
      (acc: { [key: number]: DescriptiveStats }, [key, value]: [string, DescriptiveStats]) => {
        if (value !== undefined) {
    ...
    message.cumu_damage = (object.cumu_damage !== undefined && object.cumu_damage !== null)
      ...
      : undefined;
    message.shields = (globalThis.Object.entries(object.shields ?? {}) as [string, ShieldInfo][]).reduce(
      (acc: { [key: string]: ShieldInfo }, [key, value]: [string, ShieldInfo]) => {
        if (value !== undefined) {
...
export const SimulationStatistics_ElementDpsEntry: MessageFns<SimulationStatistics_ElementDpsEntry> = {
  encode(message: SimulationStatistics_ElementDpsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      DescriptiveStats.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SimulationStatistics_ElementDpsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const SimulationStatistics_TargetDpsEntry: MessageFns<SimulationStatistics_TargetDpsEntry> = {
  encode(message: SimulationStatistics_TargetDpsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== 0) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SimulationStatistics_TargetDpsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const SimulationStatistics_ShieldsEntry: MessageFns<SimulationStatistics_ShieldsEntry> = {
  encode(message: SimulationStatistics_ShieldsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
      ShieldInfo.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SimulationStatistics_ShieldsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const SignedSimulationStatistics: MessageFns<SignedSimulationStatistics> = {
  encode(message: SignedSimulationStatistics, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.stats !== undefined) {
      SimulationStatistics.encode(message.stats, writer.uint32(10).fork()).join();
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SignedSimulationStatistics {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const DevDebugData: MessageFns<DevDebugData> = {
  encode(message: DevDebugData, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.seeded_dps !== undefined && message.seeded_dps.length !== 0) {
      for (const v of message.seeded_dps) {
        DevDebugSeededDPSResult.encode(v!, writer.uint32(10).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): DevDebugData {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          case 1: {
            ...
            const el = DevDebugSeededDPSResult.decode(reader, reader.uint32());
            if (el !== undefined) {
              message.seeded_dps!.push(el);
            }
            continue;
          }
        }
...
export const DevDebugSeededDPSResult: MessageFns<DevDebugSeededDPSResult> = {
  encode(message: DevDebugSeededDPSResult, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DevDebugSeededDPSResult {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const OverviewStats: MessageFns<OverviewStats> = {
  ...
  fromJSON(object: any): OverviewStats {
    return {
      ...
      sd: isSet(object.sd) ? globalThis.Number(object.sd) : isSet(object.SD) ? globalThis.Number(object.SD) : undefined,
      q1: isSet(object.q1) ? globalThis.Number(object.q1) : isSet(object.Q1) ? globalThis.Number(object.Q1) : undefined,
      q2: isSet(object.q2) ? globalThis.Number(object.q2) : isSet(object.Q2) ? globalThis.Number(object.Q2) : undefined,
      q3: isSet(object.q3) ? globalThis.Number(object.q3) : isSet(object.Q3) ? globalThis.Number(object.Q3) : undefined,
      histogram: globalThis.Array.isArray(object?.histogram)
        ? object.histogram.map((e: any) => globalThis.Number(e))
        : globalThis.Array.isArray(object?.hist)
        ? object.hist.map((e: any) => globalThis.Number(e))
        : [],
    };
  },
...
export const ElementStats: MessageFns<ElementStats> = {
  encode(message: ElementStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.elements || {}).forEach(([key, value]: [string, DescriptiveStats]) => {
      ElementStats_ElementsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ElementStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): ElementStats {
    return {
      elements: isObject(object.elements)
        ? (globalThis.Object.entries(object.elements) as [string, any][]).reduce(
          (acc: { [key: string]: DescriptiveStats }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: DescriptiveStats.fromJSON(value),
              enumerable: true,
  ...
  toJSON(message: ElementStats): unknown {
    const obj: any = {};
    if (message.elements) {
      const entries = globalThis.Object.entries(message.elements) as [string, DescriptiveStats][];
      if (entries.length > 0) {
        obj.elements = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<ElementStats>, I>>(object: I): ElementStats {
    const message = createBaseElementStats();
    message.elements = (globalThis.Object.entries(object.elements ?? {}) as [string, DescriptiveStats][]).reduce(
      (acc: { [key: string]: DescriptiveStats }, [key, value]: [string, DescriptiveStats]) => {
        if (value !== undefined) {
          acc[key] = DescriptiveStats.fromPartial(value);
        }
...
export const ElementStats_ElementsEntry: MessageFns<ElementStats_ElementsEntry> = {
  encode(message: ElementStats_ElementsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ElementStats_ElementsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const TargetStats: MessageFns<TargetStats> = {
  encode(message: TargetStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.targets || {}).forEach(([key, value]: [string, DescriptiveStats]) => {
      TargetStats_TargetsEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TargetStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  toJSON(message: TargetStats): unknown {
    const obj: any = {};
    if (message.targets) {
      const entries = globalThis.Object.entries(message.targets) as [string, DescriptiveStats][];
      if (entries.length > 0) {
        obj.targets = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<TargetStats>, I>>(object: I): TargetStats {
    const message = createBaseTargetStats();
    message.targets = (globalThis.Object.entries(object.targets ?? {}) as [string, DescriptiveStats][]).reduce(
      (acc: { [key: number]: DescriptiveStats }, [key, value]: [string, DescriptiveStats]) => {
        if (value !== undefined) {
          acc[globalThis.Number(key)] = DescriptiveStats.fromPartial(value);
        }
...
export const TargetStats_TargetsEntry: MessageFns<TargetStats_TargetsEntry> = {
  encode(message: TargetStats_TargetsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== 0) {
      writer.uint32(8).int32(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TargetStats_TargetsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const SourceStats: MessageFns<SourceStats> = {
  encode(message: SourceStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.sources || {}).forEach(([key, value]: [string, DescriptiveStats]) => {
      SourceStats_SourcesEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): SourceStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): SourceStats {
    return {
      sources: isObject(object.sources)
        ? (globalThis.Object.entries(object.sources) as [string, any][]).reduce(
          (acc: { [key: string]: DescriptiveStats }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: DescriptiveStats.fromJSON(value),
              enumerable: true,
  ...
  toJSON(message: SourceStats): unknown {
    const obj: any = {};
    if (message.sources) {
      const entries = globalThis.Object.entries(message.sources) as [string, DescriptiveStats][];
      if (entries.length > 0) {
        obj.sources = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<SourceStats>, I>>(object: I): SourceStats {
    const message = createBaseSourceStats();
    message.sources = (globalThis.Object.entries(object.sources ?? {}) as [string, DescriptiveStats][]).reduce(
      (acc: { [key: string]: DescriptiveStats }, [key, value]: [string, DescriptiveStats]) => {
        if (value !== undefined) {
          acc[key] = DescriptiveStats.fromPartial(value);
        }
...
export const SourceStats_SourcesEntry: MessageFns<SourceStats_SourcesEntry> = {
  encode(message: SourceStats_SourcesEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SourceStats_SourcesEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const BucketStats: MessageFns<BucketStats> = {
  encode(message: BucketStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.buckets !== undefined && message.buckets.length !== 0) {
      for (const v of message.buckets) {
        DescriptiveStats.encode(v!, writer.uint32(18).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): BucketStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const CharacterBucketStats: MessageFns<CharacterBucketStats> = {
  encode(message: CharacterBucketStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bucket_size !== undefined && message.bucket_size !== 0) {
      writer.uint32(8).uint32(message.bucket_size);
    }
    if (message.characters !== undefined && message.characters.length !== 0) {
      for (const v of message.characters) {
        CharacterBuckets.encode(v!, writer.uint32(18).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CharacterBucketStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
      ...
      while (reader.pos < end) {
        ...
        switch (tag >>> 3) {
          ...
          case 2: {
            ...
            const el = CharacterBuckets.decode(reader, reader.uint32());
            if (el !== undefined) {
...
export const CharacterBuckets: MessageFns<CharacterBuckets> = {
  encode(message: CharacterBuckets, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.buckets !== undefined && message.buckets.length !== 0) {
      for (const v of message.buckets) {
        DescriptiveStats.encode(v!, writer.uint32(10).fork()).join();
      }
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): CharacterBuckets {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const TargetBucketStats: MessageFns<TargetBucketStats> = {
  encode(message: TargetBucketStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.bucket_size !== undefined && message.bucket_size !== 0) {
      writer.uint32(8).uint32(message.bucket_size);
    }
    globalThis.Object.entries(message.targets || {}).forEach(([key, value]: [string, TargetBuckets]) => {
      TargetBucketStats_TargetsEntry.encode({ key: key as any, value }, writer.uint32(18).fork()).join();
    });
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TargetBucketStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): TargetBucketStats {
    return {
      ...
      targets: isObject(object.targets)
        ? (globalThis.Object.entries(object.targets) as [string, any][]).reduce(
          (acc: { [key: number]: TargetBuckets }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, globalThis.Number(key), {
              value: TargetBuckets.fromJSON(value),
              enumerable: true,
              configurable: true,
              writable: true,
            });
  ...
  toJSON(message: TargetBucketStats): unknown {
    ...
    if (message.targets) {
      const entries = globalThis.Object.entries(message.targets) as [string, TargetBuckets][];
      if (entries.length > 0) {
        obj.targets = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<TargetBucketStats>, I>>(object: I): TargetBucketStats {
    const message = createBaseTargetBucketStats();
    message.bucket_size = object.bucket_size ?? 0;
    message.targets = (globalThis.Object.entries(object.targets ?? {}) as [string, TargetBuckets][]).reduce(
      (acc: { [key: number]: TargetBuckets }, [key, value]: [string, TargetBuckets]) => {
        if (value !== undefined) {
...
export const TargetBucketStats_TargetsEntry: MessageFns<TargetBucketStats_TargetsEntry> = {
  encode(message: TargetBucketStats_TargetsEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== 0) {
      writer.uint32(8).int32(message.key);
    }
    if (message.value !== undefined) {
      TargetBuckets.encode(message.value, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TargetBucketStats_TargetsEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const TargetBuckets: MessageFns<TargetBuckets> = {
  encode(message: TargetBuckets, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.overall !== undefined) {
      TargetBucket.encode(message.overall, writer.uint32(10).fork()).join();
    }
    if (message.target !== undefined) {
      TargetBucket.encode(message.target, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): TargetBuckets {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const TargetBucket: MessageFns<TargetBucket> = {
  encode(message: TargetBucket, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): TargetBucket {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const FailedActions: MessageFns<FailedActions> = {
  encode(message: FailedActions, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.insufficient_energy !== undefined) {
      DescriptiveStats.encode(message.insufficient_energy, writer.uint32(10).fork()).join();
    }
    if (message.insufficient_stamina !== undefined) {
      DescriptiveStats.encode(message.insufficient_stamina, writer.uint32(18).fork()).join();
    }
    if (message.swap_cd !== undefined) {
      DescriptiveStats.encode(message.swap_cd, writer.uint32(26).fork()).join();
    }
    if (message.skill_cd !== undefined) {
      DescriptiveStats.encode(message.skill_cd, writer.uint32(34).fork()).join();
    }
    if (message.dash_cd !== undefined) {
      DescriptiveStats.encode(message.dash_cd, writer.uint32(42).fork()).join();
    }
    if (message.burst_cd !== undefined) {
      DescriptiveStats.encode(message.burst_cd, writer.uint32(50).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): FailedActions {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const ShieldInfo: MessageFns<ShieldInfo> = {
  encode(message: ShieldInfo, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    globalThis.Object.entries(message.hp || {}).forEach(([key, value]: [string, DescriptiveStats]) => {
      ShieldInfo_HpEntry.encode({ key: key as any, value }, writer.uint32(10).fork()).join();
    });
    if (message.uptime !== undefined) {
      DescriptiveStats.encode(message.uptime, writer.uint32(18).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): ShieldInfo {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): ShieldInfo {
    return {
      hp: isObject(object.hp)
        ? (globalThis.Object.entries(object.hp) as [string, any][]).reduce(
          (acc: { [key: string]: DescriptiveStats }, [key, value]: [string, any]) => {
            globalThis.Object.defineProperty(acc, key, {
              value: DescriptiveStats.fromJSON(value),
              enumerable: true,
  ...
  toJSON(message: ShieldInfo): unknown {
    const obj: any = {};
    if (message.hp) {
      const entries = globalThis.Object.entries(message.hp) as [string, DescriptiveStats][];
      if (entries.length > 0) {
        obj.hp = {};
        entries.forEach(([k, v]) => {
  ...
  fromPartial<I extends Exact<DeepPartial<ShieldInfo>, I>>(object: I): ShieldInfo {
    const message = createBaseShieldInfo();
    message.hp = (globalThis.Object.entries(object.hp ?? {}) as [string, DescriptiveStats][]).reduce(
      (acc: { [key: string]: DescriptiveStats }, [key, value]: [string, DescriptiveStats]) => {
        if (value !== undefined) {
          acc[key] = DescriptiveStats.fromPartial(value);
        }
...
export const ShieldInfo_HpEntry: MessageFns<ShieldInfo_HpEntry> = {
  encode(message: ShieldInfo_HpEntry, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.key !== "") {
      writer.uint32(10).string(message.key);
    }
    if (message.value !== undefined) {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ShieldInfo_HpEntry {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const EndStats: MessageFns<EndStats> = {
  encode(message: EndStats, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.ending_energy !== undefined) {
      DescriptiveStats.encode(message.ending_energy, writer.uint32(10).fork()).join();
    }
    return writer;
  },

  decode(input: BinaryReader | Uint8Array, length?: number): EndStats {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
