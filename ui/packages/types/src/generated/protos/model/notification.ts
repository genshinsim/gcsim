...
export const ComputeFailedEvent: MessageFns<ComputeFailedEvent> = {
  encode(message: ComputeFailedEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ComputeFailedEvent {
  ...
  fromJSON(object: any): ComputeFailedEvent {
    return {
      dbId: isSet(object.dbId)
        ? globalThis.String(object.dbId)
        : isSet(object.db_id)
        ? globalThis.String(object.db_id)
        : "",
...
export const ComputeCompletedEvent: MessageFns<ComputeCompletedEvent> = {
  encode(message: ComputeCompletedEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.dbId !== undefined && message.dbId !== "") {
      writer.uint32(10).string(message.dbId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): ComputeCompletedEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const SubmissionDeleteEvent: MessageFns<SubmissionDeleteEvent> = {
  encode(message: SubmissionDeleteEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.dbId !== undefined && message.dbId !== "") {
      writer.uint32(10).string(message.dbId);
    }
    if (message.config !== undefined && message.config !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): SubmissionDeleteEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
...
export const EntryReplaceEvent: MessageFns<EntryReplaceEvent> = {
  encode(message: EntryReplaceEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.dbId !== undefined && message.dbId !== "") {
      writer.uint32(10).string(message.dbId);
    }
    if (message.config !== undefined && message.config !== "") {
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): EntryReplaceEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): EntryReplaceEvent {
    return {
      ...
      oldConfig: isSet(object.oldConfig)
        ? globalThis.String(object.oldConfig)
        : isSet(object.old_config)
        ? globalThis.String(object.old_config)
        : "",
    };
  },
...
export const DescReplaceEvent: MessageFns<DescReplaceEvent> = {
  encode(message: DescReplaceEvent, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.dbId !== undefined && message.dbId !== "") {
      writer.uint32(10).string(message.dbId);
    }
  ...
  decode(input: BinaryReader | Uint8Array, length?: number): DescReplaceEvent {
    const reader = input instanceof BinaryReader ? input : new BinaryReader(input);
    const previousRecursionDepth = (reader as any).__tsProtoDecodeDepth ?? 0;
    if (previousRecursionDepth >= 100) {
      throw new globalThis.Error("protobuf decode recursion limit exceeded");
  ...
  fromJSON(object: any): DescReplaceEvent {
    return {
      ...
      oldDesc: isSet(object.oldDesc)
        ? globalThis.String(object.oldDesc)
        : isSet(object.old_desc)
        ? globalThis.String(object.old_desc)
        : "",
    };
  },
