...
export const AvatarPortrait = ({ char, invalid, onImageLoaded, className = "" }: AvatarPortraitProps) => {
        ...
        return (
            <div className={
                ...
                <div className="flex justify-center">
                    <img src={nahida} className=" object-contain opacity-50 h-24" onLoad={onImageLoaded} />
                </div>
            </div>
        )
            ...
            <div className={`relative w-full pt-2 z-0 ${charBG(char.element ?? "")}`}>
                ...
                <div className={
                    ...
                    <div className="flex flex-row gap-1 min-h-fit">
                        ...
                        {char.weapon ?
                            <span className="text-electro">{`R${char.weapon.refine ?? 0}`}</span>
                            :
                            null
                        }
                    </div>
                ...
                {invalid &&
                    <div className="absolute left-0 top-1/3 w-full">
                        <Badge className="flex flex-row items-center justify-center gap-2">
                            <div className="font-mono select-none text-red-500 font-bold text-xs uppercase">WIP</div>
                        </Badge>
                    </div>
                }
            </div>
