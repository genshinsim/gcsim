...
var MonsterMap = map[int]*model.MonsterData{
	21010101: {
		...
		BaseStats: &model.MonsterStatsData{
			BaseHp:  13.584,
			HpCurve: model.MonsterCurveType_GROW_CURVE_HP,
	...
	29050102: {
		...
		BaseStats: &model.MonsterStatsData{
			BaseHp:  190.176,
			HpCurve: model.MonsterCurveType_GROW_CURVE_HP_2,
			Resist: &model.MonsterResistData{
				FireResist:     0.7,
				GrassResist:    0.1,
				WaterResist:    0.1,
	...
	24060301: {
		...
		BaseStats: &model.MonsterStatsData{
			BaseHp:  19.48134,
			HpCurve: model.MonsterCurveType_GROW_CURVE_HP_ENVIRONMENT,
			Resist: &model.MonsterResistData{
				FireResist:     0.1,
				GrassResist:    0.1,
				WaterResist:    0.1,
