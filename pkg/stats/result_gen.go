...
func (z *DamageEvent) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "mitigation_modifier":
			...
			if err != nil {
				err = msgp.WrapError(err, "MitigationModifier")
				return
			}
		case "damage":
...
func (z *EndStats) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "ending_energy":
			z.EndingEnergy, err = dc.ReadFloat64()
			if err != nil {
				err = msgp.WrapError(err, "EndingEnergy")
				return
			}
		default:
			err = dc.Skip()
...
func (z EndStats) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 1
	// write "ending_energy"
	err = en.Append(0x81, 0xad, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x65, 0x6e, 0x65, 0x72, 0x67, 0x79)
	if err != nil {
		return
	}
	err = en.WriteFloat64(z.EndingEnergy)
	if err != nil {
		err = msgp.WrapError(err, "EndingEnergy")
		return
	}
...
func (z EndStats) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 1
	// string "ending_energy"
	o = append(o, 0x81, 0xad, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x65, 0x6e, 0x65, 0x72, 0x67, 0x79)
	o = msgp.AppendFloat64(o, z.EndingEnergy)
	return
}
...
func (z *EndStats) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		switch msgp.UnsafeString(field) {
		case "ending_energy":
			z.EndingEnergy, bts, err = msgp.ReadFloat64Bytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "EndingEnergy")
				return
			}
...
func (z *EnemyResult) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "cumulative_damage":
			...
			if err != nil {
				err = msgp.WrapError(err, "CumulativeDamage")
				return
			}
			if cap(z.CumulativeDamage) >= int(zb0005) {
				z.CumulativeDamage = (z.CumulativeDamage)[:zb0005]
			} else {
				z.CumulativeDamage = make([]float64, zb0005)
			}
			for za0004 := range z.CumulativeDamage {
				z.CumulativeDamage[za0004], err = dc.ReadFloat64()
				if err != nil {
					err = msgp.WrapError(err, "CumulativeDamage", za0004)
					return
				}
			}
		default:
...
func (z *EnemyResult) EncodeMsg(en *msgp.Writer) (err error) {
	...
	for za0004 := range z.CumulativeDamage {
		err = en.WriteFloat64(z.CumulativeDamage[za0004])
		if err != nil {
			err = msgp.WrapError(err, "CumulativeDamage", za0004)
			return
		}
...
func (z *EnemyResult) MarshalMsg(b []byte) (o []byte, err error) {
	...
	for za0004 := range z.CumulativeDamage {
		o = msgp.AppendFloat64(o, z.CumulativeDamage[za0004])
	}
	return
}
...
func (z *EnemyResult) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "cumulative_damage":
			...
			for za0004 := range z.CumulativeDamage {
				z.CumulativeDamage[za0004], bts, err = msgp.ReadFloat64Bytes(bts)
				if err != nil {
					err = msgp.WrapError(err, "CumulativeDamage", za0004)
					return
				}
		...
		case "field_status":
			{
				...
				zb0002, err = dc.ReadString()
				if err != nil {
					err = msgp.WrapError(err, "FieldStatus")
					return
				}
...
func (z *Result) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "end_stats":
			...
			if cap(z.EndStats) >= int(zb0008) {
				z.EndStats = (z.EndStats)[:zb0008]
			} else {
				z.EndStats = make([]EndStats, zb0008)
			}
			for za0006 := range z.EndStats {
				var zb0009 uint32
				zb0009, err = dc.ReadMapHeader()
				if err != nil {
					err = msgp.WrapError(err, "EndStats", za0006)
					return
				}
				for zb0009 > 0 {
					zb0009--
					...
					switch msgp.UnsafeString(field) {
					case "ending_energy":
						z.EndStats[za0006].EndingEnergy, err = dc.ReadFloat64()
						if err != nil {
							err = msgp.WrapError(err, "EndStats", za0006, "EndingEnergy")
							return
						}
					default:
						err = dc.Skip()
...
func (z *Result) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 12
	// write "seed"
	err = en.Append(0x8c, 0xa4, 0x73, 0x65, 0x65, 0x64)
	if err != nil {
		return
	}
	...
	// write "end_stats"
	err = en.Append(0xa9, 0x65, 0x6e, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x73)
	if err != nil {
		return
	}
	err = en.WriteArrayHeader(uint32(len(z.EndStats)))
	if err != nil {
		err = msgp.WrapError(err, "EndStats")
		return
	}
	for za0006 := range z.EndStats {
		...
		err = en.WriteFloat64(z.EndStats[za0006].EndingEnergy)
		if err != nil {
			err = msgp.WrapError(err, "EndStats", za0006, "EndingEnergy")
			return
		}
...
func (z *Result) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 12
	// string "seed"
	o = append(o, 0x8c, 0xa4, 0x73, 0x65, 0x65, 0x64)
	...
	// string "end_stats"
	o = append(o, 0xa9, 0x65, 0x6e, 0x64, 0x5f, 0x73, 0x74, 0x61, 0x74, 0x73)
	o = msgp.AppendArrayHeader(o, uint32(len(z.EndStats)))
	for za0006 := range z.EndStats {
		// map header, size 1
		// string "ending_energy"
		o = append(o, 0x81, 0xad, 0x65, 0x6e, 0x64, 0x69, 0x6e, 0x67, 0x5f, 0x65, 0x6e, 0x65, 0x72, 0x67, 0x79)
		o = msgp.AppendFloat64(o, z.EndStats[za0006].EndingEnergy)
	}
	return
}
		...
		case "end_stats":
			...
			for za0006 := range z.EndStats {
				...
				for zb0009 > 0 {
					...
					switch msgp.UnsafeString(field) {
					case "ending_energy":
						z.EndStats[za0006].EndingEnergy, bts, err = msgp.ReadFloat64Bytes(bts)
						if err != nil {
							err = msgp.WrapError(err, "EndStats", za0006, "EndingEnergy")
							return
						}
...
func (z *Result) Msgsize() (s int) {
	...
	s += 15 + msgp.BoolSize + 10 + msgp.ArrayHeaderSize + (len(z.EndStats) * (15 + msgp.Float64Size))
	return
}
