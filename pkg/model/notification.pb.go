...
var file_protos_model_notification_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x09, 0x6f, 0x6c, 0x64, 0x43, 0x6f, 0x6e, 0x66, 0x69, 0x67, 0x42,
...
var file_protos_model_notification_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
var file_protos_model_notification_proto_goTypes = []interface{}{
...
func file_protos_model_notification_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_protos_model_notification_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_model_notification_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_model_notification_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
		...
		file_protos_model_notification_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
