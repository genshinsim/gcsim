...
type SimulationStatistics struct {
	...
	// er values from er_calc mode
	ErNeeded   []*OverviewStats `protobuf:"bytes,31,rep,name=er_needed,proto3" json:"er_needed,omitempty" bson:"er_needed,omitempty"`
	WeightedEr []*OverviewStats `protobuf:"bytes,32,rep,name=weighted_er,proto3" json:"weighted_er,omitempty" bson:"weighted_er,omitempty"`
}
...
func (x *SimulationStatistics) GetErNeeded() []*OverviewStats {
	if x != nil {
		return x.ErNeeded
	}
	return nil
...
func (x *SimulationStatistics) GetWeightedEr() []*OverviewStats {
	if x != nil {
		return x.WeightedEr
	}
	return nil
...
var file_protos_model_result_proto_rawDesc = []byte{
	...
	0x09, 0x5f, 0x6d, 0x6f, 0x64, 0x69, 0x66, 0x69, 0x65, 0x64, 0x22, 0xd4, 0x0f, 0x0a, 0x14, 0x53,
	...
	,
...
var file_protos_model_result_proto_depIdxs = []int32{
	...
	17, // 26: model.SimulationStatistics.shields:type_name -> model.SimulationStatistics.ShieldsEntry
	5,  // 27: model.SimulationStatistics.field_time:type_name -> model.DescriptiveStats
	8,  // 28: model.SimulationStatistics.total_source_energy:type_name -> model.SourceStats
	8,  // 29: model.SimulationStatistics.source_reactions:type_name -> model.SourceStats
	8,  // 30: model.SimulationStatistics.character_actions:type_name -> model.SourceStats
	8,  // 31: model.SimulationStatistics.target_aura_uptime:type_name -> model.SourceStats
	4,  // 32: model.SimulationStatistics.er_needed:type_name -> model.OverviewStats
	4,  // 33: model.SimulationStatistics.weighted_er:type_name -> model.OverviewStats
	2,  // 34: model.SignedSimulationStatistics.stats:type_name -> model.SimulationStatistics
	18, // 35: model.ElementStats.elements:type_name -> model.ElementStats.ElementsEntry
	19, // 36: model.TargetStats.targets:type_name -> model.TargetStats.TargetsEntry
	20, // 37: model.SourceStats.sources:type_name -> model.SourceStats.SourcesEntry
	...
	5,  // 41: model.FailedActions.insufficient_energy:type_name -> model.DescriptiveStats
	5,  // 42: model.FailedActions.insufficient_stamina:type_name -> model.DescriptiveStats
	5,  // 43: model.FailedActions.swap_cd:type_name -> model.DescriptiveStats
	5,  // 44: model.FailedActions.skill_cd:type_name -> model.DescriptiveStats
	5,  // 45: model.FailedActions.dash_cd:type_name -> model.DescriptiveStats
	21, // 46: model.ShieldInfo.hp:type_name -> model.ShieldInfo.HpEntry
	5,  // 47: model.ShieldInfo.uptime:type_name -> model.DescriptiveStats
	5,  // 48: model.SimulationStatistics.ElementDpsEntry.value:type_name -> model.DescriptiveStats
	5,  // 49: model.SimulationStatistics.TargetDpsEntry.value:type_name -> model.DescriptiveStats
	14, // 50: model.SimulationStatistics.ShieldsEntry.value:type_name -> model.ShieldInfo
	5,  // 51: model.ElementStats.ElementsEntry.value:type_name -> model.DescriptiveStats
	5,  // 52: model.TargetStats.TargetsEntry.value:type_name -> model.DescriptiveStats
	5,  // 53: model.SourceStats.SourcesEntry.value:type_name -> model.DescriptiveStats
	5,  // 54: model.ShieldInfo.HpEntry.value:type_name -> model.DescriptiveStats
