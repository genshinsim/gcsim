...
type DBEntry struct {
	...
	CreateDate  uint64            `protobuf:"varint,2,opt,name=create_date,json=createDate,proto3" json:"create_date,omitempty" bson:"createDate,omitempty"`
	RunDate     uint64            `protobuf:"varint,3,opt,name=run_date,json=runDate,proto3" json:"run_date,omitempty" bson:"runDate,omitempty"`
	SimDuration *DescriptiveStats `protobuf:"bytes,4,opt,name=sim_duration,json=simDuration,proto3" json:"sim_duration,omitempty" bson:"simDuration,omitempty"`
	...
	// indexing data
	TotalDamage      *DescriptiveStats `protobuf:"bytes,7,opt,name=total_damage,json=totalDamage,proto3" json:"total_damage,omitempty" bson:"totalDamage,omitempty"`
	CharNames        []string          `protobuf:"bytes,8,rep,name=char_names,json=charNames,proto3" json:"char_names,omitempty" bson:"charNames,omitempty"`
	TargetCount      int32             `protobuf:"varint,9,opt,name=target_count,json=targetCount,proto3" json:"target_count,omitempty" bson:"targetCount,omitempty"`
	MeanDpsPerTarget float64           `protobuf:"fixed64,10,opt,name=mean_dps_per_target,json=meanDpsPerTarget,proto3" json:"mean_dps_per_target,omitempty" bson:"meanDpsPerTarget,omitempty"`
	// detailed results
	Team        []*Character                 `protobuf:"bytes,11,rep,name=team,proto3" json:"team,omitempty" bson:"team,omitempty"`
	DpsByTarget map[string]*DescriptiveStats `protobuf:"bytes,12,rep,name=dps_by_target,json=dpsByTarget,proto3" json:"dps_by_target,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3" bson:"dpsByTarget,omitempty"`
}
...
var file_protos_model_db_proto_rawDesc = []byte{
	...
	0x3a, 0x02, 0x38, 0x01, 0x22, 0x2f, 0x0a, 0x09, 0x44, 0x42, 0x45, 0x6e, 0x74, 0x72, 0x69, 0x65,
	...
	0x04, 0x64, 0x61, 0x74, 0x61, 0x42, 0x0b, 0x5a, 0x09, 0x70, 0x6b, 0x67, 0x2f, 0x6d, 0x6f, 0x64,
