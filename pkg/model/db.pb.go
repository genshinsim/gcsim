...
type DBQueryOpt struct {
	...
	Query   *_struct.Struct `protobuf:"bytes,1,opt,name=query,proto3" json:"query,omitempty" bson:"query,omitempty"`
	Sort    *_struct.Struct `protobuf:"bytes,2,opt,name=sort,proto3" json:"sort,omitempty" bson:"sort,omitempty"`
	Project *_struct.Struct `protobuf:"bytes,3,opt,name=project,proto3" json:"project,omitempty" bson:"project,omitempty"`
...
func (x *DBQueryOpt) GetQuery() *_struct.Struct {
	if x != nil {
		return x.Query
	}
	return nil
...
func (x *DBQueryOpt) GetSort() *_struct.Struct {
	if x != nil {
		return x.Sort
	}
	return nil
...
func (x *DBQueryOpt) GetProject() *_struct.Struct {
	if x != nil {
		return x.Project
	}
	return nil
...
var file_protos_model_db_proto_rawDesc = []byte{
	...
	0x03, 0x63, 0x66, 0x67, 0x42, 0x27, 0x5a, 0x25, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_protos_model_db_proto_depIdxs = []int32{
	...
	0,  // 5: model.DBEntries.data:type_name -> model.DBEntry
