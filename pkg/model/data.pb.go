...
type AvatarDataMap struct {
	...
	Data map[string]*AvatarData `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type WeaponDataMap struct {
	...
	Data map[string]*WeaponData `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
type ArtifactDataMap struct {
	...
	Data map[string]*ArtifactData `protobuf:"bytes,1,rep,name=data,proto3" json:"data,omitempty" protobuf_key:"bytes,1,opt,name=key,proto3" protobuf_val:"bytes,2,opt,name=value,proto3"`
}
...
func file_protos_model_data_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_protos_model_data_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*ArtifactImageData); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_protos_model_data_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
