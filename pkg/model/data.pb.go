...
type AvatarData struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	Id              uint32                 `protobuf:"varint,1,opt,name=id,proto3" json:"id,omitempty" bson:"id,omitempty"`
	SubId           uint32                 `protobuf:"varint,2,opt,name=sub_id,proto3" json:"sub_id,omitempty" bson:"sub_id,omitempty"`
	...
	Region          AssocType              `protobuf:"varint,6,opt,name=region,proto3,enum=model.AssocType" json:"region,omitempty" bson:"region,omitempty"`
	Element         ElementType            `protobuf:"varint,7,opt,name=element,proto3,enum=model.ElementType" json:"element,omitempty" bson:"element,omitempty"`
	WeaponClass     WeaponType             `protobuf:"varint,8,opt,name=weapon_class,proto3,enum=model.WeaponType" json:"weapon_class,omitempty" bson:"weapon_class,omitempty"`
	...
	NameTextHashMap uint32                 `protobuf:"varint,12,opt,name=name_text_hash_map,proto3" json:"name_text_hash_map,omitempty" bson:"name_text_hash_map,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *AvatarData) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *AvatarData) GetSubId() uint32 {
	if x != nil {
		return x.SubId
	}
	return 0
...
func (x *AvatarData) GetRarity() QualityType {
	...
	return QualityType_QUALITY_NONE
}
...
func (x *AvatarData) GetBody() BodyType {
	...
	return BodyType_BODY_NONE
}

func (x *AvatarData) GetRegion() AssocType {
	if x != nil {
		return x.Region
	}
	return AssocType_ASSOC_TYPE_NONE
}

func (x *AvatarData) GetElement() ElementType {
	if x != nil {
		return x.Element
	}
...
func (x *AvatarData) GetWeaponClass() WeaponType {
	if x != nil {
		return x.WeaponClass
	}
	return WeaponType_WEAPON_NONE
}
...
func (x *AvatarData) GetNameTextHashMap() uint32 {
	if x != nil {
...
type AvatarStatsData struct {
	...
	HpCurve        GrowCurveType    `protobuf:"varint,4,opt,name=hp_curve,proto3,enum=model.GrowCurveType" json:"hp_curve,omitempty" bson:"hp_curve,omitempty"`
	AtkCurve       GrowCurveType    `protobuf:"varint,5,opt,name=atk_curve,proto3,enum=model.GrowCurveType" json:"atk_curve,omitempty" bson:"atk_curve,omitempty"`
	DefCruve       GrowCurveType    `protobuf:"varint,6,opt,name=def_cruve,proto3,enum=model.GrowCurveType" json:"def_cruve,omitempty" bson:"def_cruve,omitempty"`
...
func (x *AvatarStatsData) GetHpCurve() GrowCurveType {
	if x != nil {
		return x.HpCurve
	}
	return GrowCurveType_GROW_CURVE_NONE
}

func (x *AvatarStatsData) GetAtkCurve() GrowCurveType {
	if x != nil {
		return x.AtkCurve
	}
	return GrowCurveType_GROW_CURVE_NONE
...
func (x *AvatarStatsData) GetDefCruve() GrowCurveType {
	if x != nil {
		return x.DefCruve
	}
	return GrowCurveType_GROW_CURVE_NONE
...
type AvatarSkillsData struct {
	state           protoimpl.MessageState       `protogen:"open.v1"`
	Skill           uint32                       `protobuf:"varint,1,opt,name=skill,proto3" json:"skill,omitempty" bson:"skill,omitempty"`
	Burst           uint32                       `protobuf:"varint,2,opt,name=burst,proto3" json:"burst,omitempty" bson:"burst,omitempty"`
	Attack          uint32                       `protobuf:"varint,3,opt,name=attack,proto3" json:"attack,omitempty" bson:"attack,omitempty"`
	A1              uint32                       `protobuf:"varint,10,opt,name=a1,proto3" json:"a1,omitempty" bson:"a1,omitempty"`
	A4              uint32                       `protobuf:"varint,11,opt,name=a4,proto3" json:"a4,omitempty" bson:"a4,omitempty"`
...
func (x *AvatarSkillsData) GetSkill() uint32 {
	if x != nil {
		return x.Skill
	}
	return 0
...
func (x *AvatarSkillsData) GetBurst() uint32 {
	if x != nil {
		return x.Burst
	}
	return 0
...
func (x *AvatarSkillsData) GetAttack() uint32 {
	if x != nil {
		return x.Attack
	}
	return 0
...
func (x *AvatarSkillsData) GetA1() uint32 {
	if x != nil {
		return x.A1
	}
	return 0
...
func (x *AvatarSkillsData) GetA4() uint32 {
	if x != nil {
		return x.A4
	}
	return 0
...
type AvatarSkillExcelIndexData struct {
	state         protoimpl.MessageState       `protogen:"open.v1"`
	GroupId       uint32                       `protobuf:"varint,1,opt,name=group_id,proto3" json:"group_id,omitempty" bson:"group_id,omitempty"`
	Index         uint32                       `protobuf:"varint,2,opt,name=index,proto3" json:"index,omitempty" bson:"index,omitempty"` // position in the param list
...
func (x *AvatarSkillExcelIndexData) GetGroupId() uint32 {
	if x != nil {
		return x.GroupId
	}
	return 0
...
func (x *AvatarSkillExcelIndexData) GetIndex() uint32 {
	if x != nil {
		return x.Index
	}
	return 0
...
type AvatarSkillExcelLevelData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Level         uint32                 `protobuf:"varint,1,opt,name=level,proto3" json:"level,omitempty" bson:"level,omitempty"`
...
func (x *AvatarSkillExcelLevelData) GetLevel() uint32 {
	if x != nil {
		return x.Level
	}
	return 0
...
type WeaponData struct {
	...
	Rarity          uint32                 `protobuf:"varint,3,opt,name=rarity,proto3" json:"rarity,omitempty" bson:"rarity,omitempty"` // for whatever reason weapon rarity is a number
	WeaponClass     WeaponType             `protobuf:"varint,4,opt,name=weapon_class,proto3,enum=model.WeaponType" json:"weapon_class,omitempty" bson:"weapon_class,omitempty"`
	...
	NameTextHashMap uint32                 `protobuf:"varint,7,opt,name=name_text_hash_map,proto3" json:"name_text_hash_map,omitempty" bson:"name_text_hash_map,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *WeaponData) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *WeaponData) GetRarity() uint32 {
	if x != nil {
		return x.Rarity
	}
	return 0
...
func (x *WeaponData) GetWeaponClass() WeaponType {
	if x != nil {
		return x.WeaponClass
	}
	return WeaponType_WEAPON_NONE
...
func (x *WeaponData) GetNameTextHashMap() uint32 {
	if x != nil {
		return x.NameTextHashMap
	}
	return 0
...
type WeaponProp struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	PropType      FightPropType          `protobuf:"varint,1,opt,name=prop_type,proto3,enum=model.FightPropType" json:"prop_type,omitempty" bson:"prop_type,omitempty"`
	...
	Curve         GrowCurveType          `protobuf:"varint,3,opt,name=curve,proto3,enum=model.GrowCurveType" json:"curve,omitempty" bson:"curve,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *WeaponProp) GetPropType() FightPropType {
	if x != nil {
		return x.PropType
	}
	return FightPropType_FIGHT_PROP_NONE
}
...
func (x *WeaponProp) GetCurve() GrowCurveType {
	if x != nil {
		return x.Curve
	}
	return GrowCurveType_GROW_CURVE_NONE
...
type ArtifactData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	SetId         uint32                 `protobuf:"varint,1,opt,name=set_id,json=id,proto3" json:"set_id,omitempty" bson:"id,omitempty"`
	TextMapId     uint32                 `protobuf:"varint,2,opt,name=text_map_id,proto3" json:"text_map_id,omitempty" bson:"text_map_id,omitempty"`
	Key           string                 `protobuf:"bytes,3,opt,name=key,proto3" json:"key,omitempty" bson:"key,omitempty"`
...
func (x *ArtifactData) GetSetId() uint32 {
	if x != nil {
		return x.SetId
	}
	return 0
...
func (x *ArtifactData) GetTextMapId() uint32 {
	if x != nil {
		return x.TextMapId
	}
	return 0
...
type PromotionData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	MaxLevel      uint32                 `protobuf:"varint,1,opt,name=max_level,proto3" json:"max_level,omitempty" bson:"max_level,omitempty"`
...
func (x *PromotionData) GetMaxLevel() uint32 {
	if x != nil {
		return x.MaxLevel
	}
	return 0
...
func (x *PromotionAddProp) GetPropType() FightPropType {
	if x != nil {
		return x.PropType
	}
	return FightPropType_FIGHT_PROP_NONE
...
type MonsterData struct {
	...
	NameTextHashMap uint32                 `protobuf:"varint,4,opt,name=name_text_hash_map,proto3" json:"name_text_hash_map,omitempty" bson:"name_text_hash_map,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *MonsterData) GetId() uint32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *MonsterData) GetNameTextHashMap() uint32 {
	if x != nil {
		return x.NameTextHashMap
	}
	return 0
...
type MonsterStatsData struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	BaseHp        float64                `protobuf:"fixed64,1,opt,name=base_hp,proto3" json:"base_hp,omitempty" bson:"base_hp,omitempty"`
	HpCurve       GrowCurveType          `protobuf:"varint,2,opt,name=hp_curve,proto3,enum=model.GrowCurveType" json:"hp_curve,omitempty" bson:"hp_curve,omitempty"`
...
func (x *MonsterStatsData) GetHpCurve() GrowCurveType {
	if x != nil {
		return x.HpCurve
	}
	return GrowCurveType_GROW_CURVE_NONE
...
type MonsterHPDrop struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	DropId        uint32                 `protobuf:"varint,1,opt,name=drop_id,proto3" json:"drop_id,omitempty" bson:"drop_id,omitempty"`
...
func (x *MonsterHPDrop) GetDropId() uint32 {
	if x != nil {
		return x.DropId
	}
	return 0
...
const file_protos_model_data_proto_rawDesc = "" +
	...
	"\x05value\x18\x02 \x01(\v2\x11.model.AvatarDataR\x05value:\x028\x01\"\xe1\x03\n" +
	"\n" +
	"AvatarData\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x16\n" +
	"\x06sub_id\x18\x02 \x01(\rR\x06sub_id\x12\x10\n" +
	...
	"\x06region\x18\x06 \x01(\x0e2\x10.model.AssocTypeR\x06region\x12,\n" +
	"\aelement\x18\a \x01(\x0e2\x12.model.ElementTypeR\aelement\x125\n" +
	"\fweapon_class\x18\b \x01(\x0e2\x11.model.WeaponTypeR\fweapon_class\x12\x1c\n" +
	...
	"\x12name_text_hash_map\x18\f \x01(\rR\x12name_text_hash_map\"\xdd\x02\n" +
	"\x0fAvatarStatsData\x12\x18\n" +
	"\abase_hp\x18\x01 \x01(\x01R\abase_hp\x12\x1a\n" +
	"\bbase_atk\x18\x02 \x01(\x01R\bbase_atk\x12\x1a\n" +
	"\bbase_def\x18\x03 \x01(\x01R\bbase_def\x120\n" +
	"\bhp_curve\x18\x04 \x01(\x0e2\x14.model.GrowCurveTypeR\bhp_curve\x122\n" +
	"\tatk_curve\x18\x05 \x01(\x0e2\x14.model.GrowCurveTypeR\tatk_curve\x122\n" +
	"\tdef_cruve\x18\x06 \x01(\x0e2\x14.model.GrowCurveTypeR\tdef_cruve\x124\n" +
	"\n" +
	...
	"\x05skill\x18\x01 \x01(\rR\x05skill\x12\x14\n" +
	"\x05burst\x18\x02 \x01(\rR\x05burst\x12\x16\n" +
	"\x06attack\x18\x03 \x01(\rR\x06attack\x12\x0e\n" +
	"\x02a1\x18\n" +
	" \x01(\rR\x02a1\x12\x0e\n" +
	"\x02a4\x18\v \x01(\rR\x02a4\x12,\n" +
	...
	"\bgroup_id\x18\x01 \x01(\rR\bgroup_id\x12\x14\n" +
	...
	"\tDataEntry\x12\x10\n" +
	"\x03key\x18\x01 \x01(\tR\x03key\x12'\n" +
	"\x05value\x18\x02 \x01(\v2\x11.model.WeaponDataR\x05value:\x028\x01\"\x85\x02\n" +
	"\n" +
	"WeaponData\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\rR\x02id\x12\x10\n" +
	"\x03key\x18\x02 \x01(\tR\x03key\x12\x16\n" +
	"\x06rarity\x18\x03 \x01(\rR\x06rarity\x125\n" +
	"\fweapon_class\x18\x04 \x01(\x0e2\x11.model.WeaponTypeR\fweapon_class\x12\x1e\n" +
	"\n" +
	...
	"base_stats\x12.\n" +
	"\x12name_text_hash_map\x18\a \x01(\rR\x12name_text_hash_map\"z\n" +
	...
	"\n" +
	"WeaponProp\x122\n" +
	"\tprop_type\x18\x01 \x01(\x0e2\x14.model.FightPropTypeR\tprop_type\x12$\n" +
	"\rinitial_value\x18\x02 \x01(\x01R\rinitial_value\x12*\n" +
	"\x05curve\x18\x03 \x01(\x0e2\x14.model.GrowCurveTypeR\x05curve\"\x95\x01\n" +
	...
	"\x06set_id\x18\x01 \x01(\rR\x02id\x12 \n" +
	"\vtext_map_id\x18\x02 \x01(\rR\vtext_map_id\x12\x10\n" +
	"\x03key\x18\x03 \x01(\tR\x03key\x12:\n" +
	...
	"\tmax_level\x18\x01 \x01(\rR\tmax_level\x125\n" +
	"\tadd_props\x18\x02 \x03(\v2\x17.model.PromotionAddPropR\tadd_props\"\\\n" +
	"\x10PromotionAddProp\x122\n" +
	"\tprop_type\x18\x01 \x01(\x0e2\x14.model.FightPropTypeR\tprop_type\x12\x14\n" +
	...
	"base_stats\x12.\n" +
	"\x12name_text_hash_map\x18\x04 \x01(\rR\x12name_text_hash_map\"\xe6\x01\n" +
	"\x10MonsterStatsData\x12\x18\n" +
	"\abase_hp\x18\x01 \x01(\x01R\abase_hp\x120\n" +
	"\bhp_curve\x18\x02 \x01(\x0e2\x14.model.GrowCurveTypeR\bhp_curve\x120\n" +
	...
	"\adrop_id\x18\x01 \x01(\rR\adrop_id\x12\x1e\n" +
	"\n" +
...
var file_protos_model_data_proto_goTypes = []any{
	...
	(AssocType)(0),                    // 24: model.AssocType
	(ElementType)(0),                  // 25: model.ElementType
	(WeaponType)(0),                   // 26: model.WeaponType
	(GrowCurveType)(0),                // 27: model.GrowCurveType
	(FightPropType)(0),                // 28: model.FightPropType
}
var file_protos_model_data_proto_depIdxs = []int32{
	...
	24, // 3: model.AvatarData.region:type_name -> model.AssocType
	25, // 4: model.AvatarData.element:type_name -> model.ElementType
	26, // 5: model.AvatarData.weapon_class:type_name -> model.WeaponType
	...
	27, // 8: model.AvatarStatsData.hp_curve:type_name -> model.GrowCurveType
	27, // 9: model.AvatarStatsData.atk_curve:type_name -> model.GrowCurveType
	27, // 10: model.AvatarStatsData.def_cruve:type_name -> model.GrowCurveType
	...
	26, // 19: model.WeaponData.weapon_class:type_name -> model.WeaponType
	...
	28, // 23: model.WeaponProp.prop_type:type_name -> model.FightPropType
	27, // 24: model.WeaponProp.curve:type_name -> model.GrowCurveType
	...
	28, // 28: model.PromotionAddProp.prop_type:type_name -> model.FightPropType
	16, // 29: model.MonsterData.base_stats:type_name -> model.MonsterStatsData
	27, // 30: model.MonsterStatsData.hp_curve:type_name -> model.GrowCurveType
