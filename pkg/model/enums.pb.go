...
const (
	Element_None               Element = 0
	Element_Fire               Element = 1
	Element_Water              Element = 2
	Element_Grass              Element = 3
	Element_Electric           Element = 4
	Element_Ice                Element = 5
	Element_Frozen             Element = 6
	Element_Wind               Element = 7
	Element_Rock               Element = 8
	Element_AntiFire           Element = 9
	Element_VechicleMuteIce    Element = 10
	Element_Mushroom           Element = 11
	Element_Overdose           Element = 12
	Element_Wood               Element = 13
	Element_LiquidPhlogiston   Element = 14
	Element_SolidPhlogiston    Element = 15
	Element_SolidifyPhlogiston Element = 16
	Element_Burning            Element = 17 // TODO: remove in future
	Element_BurningFuel        Element = 18 // TODO: remove in future
	Element_COUNT              Element = 19
)
...
const file_protos_model_enums_proto_rawDesc = "" +
	...
	"\x12\x1b\n" +
	"\x17ASSOC_TYPE_OMNI_SCOURGE\x10\v*\x9f\x02\n" +
	"\aElement\x12\b\n" +
	...
	"\x04Wind\x10\a\x12\b\n" +
	"\x04Rock\x10\b\x12\f\n" +
	"\bAntiFire\x10\t\x12\x13\n" +
	"\x0fVechicleMuteIce\x10\n" +
	"\x12\f\n" +
	"\bMushroom\x10\v\x12\f\n" +
	"\bOverdose\x10\f\x12\b\n" +
	"\x04Wood\x10\r\x12\x14\n" +
	"\x10LiquidPhlogiston\x10\x0e\x12\x13\n" +
	"\x0fSolidPhlogiston\x10\x0f\x12\x16\n" +
	"\x12SolidifyPhlogiston\x10\x10\x12\v\n" +
	"\aBurning\x10\x11\x12\x0f\n" +
	"\vBurningFuel\x10\x12\x12\t\n" +
	"\x05COUNT\x10\x13*\xf8\x05\n" +
	"\bStatType\x12\x15\n" +
