...
var charPrettyName = []string{
	"Invalid",
	"Traveler Electro (Male)",
	"Traveler Electro (Female)",
	"Traveler Anemo (Male)",
	"Traveler Anemo (Female)",
	"Traveler Geo (Male)",
	"Traveler Geo (Female)",
	"Traveler Hydro",
	"Traveler Cryo",
...
var CharKeyToEle = map[Char]attributes.Element{
	TravelerElectroMale:   attributes.Electro,
	TravelerElectroFemale: attributes.Electro,
	TravelerAnemoMale:     attributes.Anemo,
	TravelerAnemoFemale:   attributes.Anemo,
	TravelerGeoMale:       attributes.Geo,
	TravelerGeoFemale:     attributes.Geo,
