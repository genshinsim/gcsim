...
type Event interface {
	...
	WriteBuildMsg(keyAndVal ...any) Event // write additional keyAndVal pairs to the event
	Write(key string, val any) Event      // write additional keyAndVal pairs to the event
