...
// func (c *StatsHandler) CDReduction(a action.Action, dur int, char int) int {
// 	var cd float64 = 1
// 	n := 0
...
// func (c *StatsHandler) AddCDAdjust(key string, dur int, amt func(a action.Action) float64, chars ...int) {
