...
// func (h *StatsHandler) AddStatMod(key string, dur int, affected attributes.Stat, f StatModFunc, chars ...int) {
...
// func (h *StatsHandler) DeleteStatMod(key string, char int) {
// 	n := 0
...
// func (h *StatsHandler) StatModIsActive(key string, char int) bool {
// 	ind := -1
// 	for i, v := range h.statsMod[char] {
// 		if v.Key == key {
// 			ind = i
