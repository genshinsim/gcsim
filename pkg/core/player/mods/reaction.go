...
func (h *Handler) ReactBonus(atk combat.AttackInfo, char int) (amt float64) {
	n := 0
...
func (h *Handler) ReactBonusModIsActive(key string, char int) bool {
	ind := -1
...
func (h *Handler) AddReactBonusMod(key string, dur int, f ReactBonusModFunc, chars ...int) {
