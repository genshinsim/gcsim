...
// func (h *StatsHandler) Stats(char int) ([attributes.EndStatType]float64, []interface{}) {
...
// func (h *StatsHandler) Stat(char int, s attributes.Stat) float64 {
...
// func (h *StatsHandler) MaxHP(char int) float64 {
// 	hpp := h.team[char].stats[attributes.HPP]
// 	hp := h.team[char].stats[attributes.HP]
