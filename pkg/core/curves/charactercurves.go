	...
	keys.Charlotte: {
		...
		PromotionBonus: []PromoData{
			...
			},
			{
				MaxLevel: 50,
				HP:       1153.4814453125,
				Atk:      18.546546936035156,
				Def:      58.5,
				Special:  0.05999999865889549,
			},
			{
				MaxLevel: 60,
				HP:       1792.332763671875,
				Atk:      28.8184814453125,
			...
			},
			{
				MaxLevel: 70,
				HP:       2271.47119140625,
				Atk:      36.522430419921875,
				Def:      115.19999694824219,
				Special:  0.11999999731779099,
			},
			{
				MaxLevel: 80,
				HP:       2750.609619140625,
				Atk:      44.226383209228516,
				Def:      139.5,
				Special:  0.18000000715255737,
			},
			{
	...
	keys.Chevreuse: {
		...
		PromotionBonus: []PromoData{
			...
			},
			{
				MaxLevel: 40,
				HP:       749.27001953125,
				Atk:      12.106457710266113,
				Def:      37.87649917602539,
				Special:  0,
			},
			{
				MaxLevel: 50,
				HP:       1281.6461181640625,
				Atk:      20.70841407775879,
				Def:      64.78874969482422,
				Special:  0.05999999865889549,
			},
			{
				MaxLevel: 60,
				HP:       1991.4808349609375,
				Atk:      32.17769241333008,
				Def:      100.6717529296875,
				Special:  0.11999999731779099,
			},
			{
				MaxLevel: 70,
				HP:       2523.85693359375,
				Atk:      40.77964782714844,
				Def:      127.58399963378906,
				Special:  0.11999999731779099,
			},
			{
				MaxLevel: 80,
				HP:       3056.23291015625,
				Atk:      49.3816032409668,
				Def:      154.49624633789062,
				Special:  0.18000000715255737,
			},
			{
				MaxLevel: 90,
				HP:       3588.609130859375,
				Atk:      57.98356246948242,
				Def:      181.4084930419922,
				Special:  0.23999999463558197,
			},
		},
	},
	...
	keys.Navia: {
		...
		PromotionBonus: []PromoData{
			...
			},
			{
				...
				Atk:      40.14055633544922,
				Def:      90.55799865722656,
				Special:  0.09600000083446503,
			},
			{
				MaxLevel: 60,
				HP:       2244.218505859375,
				Atk:      62.37224578857422,
				Def:      140.71319580078125,
				Special:  0.19200000166893005,
			},
			{
				MaxLevel: 70,
				HP:       2844.157958984375,
				Atk:      79.04601287841797,
				Def:      178.32960510253906,
				Special:  0.19200000166893005,
			},
			{
				MaxLevel: 80,
				HP:       3444.09765625,
				Atk:      95.71978759765625,
				Def:      215.9459991455078,
				Special:  0.2879999876022339,
			},
			{
				MaxLevel: 90,
