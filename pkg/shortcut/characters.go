...
var CharNameToKey = map[string]keys.Char{
	"travelerelectromale":   keys.TravelerElectroMale,
	"travelerelectrofemale": keys.TravelerElectroFemale,
	"travelerelectro":       keys.TravelerElectroFemale,
	"traveleranemomale":     keys.TravelerAnemoMale,
	"traveleranemofemale":   keys.TravelerAnemoFemale,
	"traveleranemo":         keys.TravelerAnemoFemale,
	"travelergeomale":       keys.TravelerGeoMale,
	"travelergeofemale":     keys.TravelerGeoFemale,
	"travelergeo":           keys.TravelerGeoFemale,
