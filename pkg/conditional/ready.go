...
func evalReady(c *core.Core, fields []string) int64 {
	if len(fields) < 3 {
		c.Log.NewEvent("bad ready conditon: invalid num of fields", glog.LogWarnings, -1, "fields", fields)
		return 0
	}
	...
	if !ok {
		c.Log.NewEvent("bad ready conditon: invalid character", glog.LogWarnings, -1, "fields", fields)
		return 0
	}
	...
	if ak == action.InvalidAction {
		c.Log.NewEvent("bad ready conditon: invalid action", glog.LogWarnings, -1, "fields", fields)
		return 0
	}
