...
- `Slither entry stamina threshold` remains open as a semantics-validation item because the current code checks roughly one second of Slither drain up front without consuming it immediately.
