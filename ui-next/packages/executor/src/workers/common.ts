export namespace Aggregator {
  ...
  export function InitializeResponse(result: unknown): InitializeResponse {
  ...
  export function ResultResponse(result: { hash: string; stats: unknown }): ResultResponse {
...
export namespace Helper {
  ...
  export function ValidateRequest(id: number, cfg: string): ValidateRequest {
    return { id: id, type: Request.Validate, cfg: cfg };
  }
  ...
  export function ValidateResponse(id: number, cfg: unknown): ValidateResponse {
  ...
  export function SampleRequest(id: number, cfg: string, seed: string): SampleRequest {
    return { id: id, type: Request.Sample, cfg: cfg, seed: seed };
  }
