...
func (c *embedClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/preview.Embed/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func RegisterEmbedServer(s *grpc.Server, srv EmbedServer) {
	s.RegisterService(&_Embed_serviceDesc, srv)
}
...
var _Embed_serviceDesc = grpc.ServiceDesc{
